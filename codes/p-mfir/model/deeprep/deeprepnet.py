...
import model.deeprep.initializers as initializers
import model.deeprep.encoders as encoders
import model.deeprep.degradation_layers as ds_layers
import model.deeprep.optimizer_modules as optimizer_modules
import model.deeprep.decoders as decoders
import model.deeprep.weight_predictors as weightpredictors
from model.alignment.pyrcorr import PyrCorr

from model.deeprep.alignment import PWCNetAlignment, AlignmentWrapper
...
def deeprep_sr_iccv21(num_iter, enc_dim=32, enc_num_res_blocks=3, enc_out_dim=64,
    ...
    lr_encoder = encoders.ResEncoder(input_channels=16, init_dim=enc_dim, num_res_blocks=enc_num_res_blocks,
                                     out_dim=enc_out_dim)
