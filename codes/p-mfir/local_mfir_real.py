class Config:
    def __init__(self):
        ...
        self.path_model_selected = f'{self.path_model}/pmfir_model_real.pth'
        self.path_image_original = "../../rsp_dataset/train_val/gt/val"
        self.path_image_gt = "../../PolarBurstSR/test"
        self.path_image_output = "../../PolarBurstSR/pmfir_real"
        ...
        self.path_base_model = '../../checkpoints/pmfir_model_syn.pth'
