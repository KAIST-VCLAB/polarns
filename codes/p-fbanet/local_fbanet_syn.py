class Config:
    def __init__(self):
        ...
        self.path_model_selected = f'{self.path_model}/pfbanet_model_syn.pth'
        self.path_image_original = "../../rsp_dataset/train_val/gt/val"
        self.path_image_gt = "../../test_48x48_down2_v2"
        self.path_image_output = "../../syn_pfbanet"
        
        self.image_type = 'polar'
        
        self.output_format = 'degree'

        self.is_fine_tuning = False
        self.path_base_model = None
        ...
        self.device = ['cuda:0']
        self.info_bursts = {}
        self.info_bursts['max_rotation'] = 0
        self.info_bursts['max_translation'] = 0
