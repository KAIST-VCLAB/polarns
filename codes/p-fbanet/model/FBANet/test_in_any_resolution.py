...
from ManualDataset import ManualDatasets, ManualDatasets_test, ManualDatasets_validation
...
parser.add_argument('--input_dir', default='/root/data/polar/RealBSR/RGB',
                    type=str, help='Directory of validation images')
# /userhome/aimia/sunyj/Dataset/Manual/Manual_dataset-v2
# /userhome/aimia/sunyj/Dataset/DRealBSR_RGB/
parser.add_argument('--result_dir', default='./results/Motion_MFSR_0.5/',
...
test_dataset = ManualDatasets_validation(root=args.input_dir, burst_size=14, split='val')
    ...
    for ii, data_test in enumerate(tqdm(test_loader), 0):
        ...
        with torch.cuda.amp.autocast():
            ...
            for idx in range(iters):
                ...
                # for i in range(14):
                #     cv2.imwrite(f'results/color_temp{i:02d}.png', (input[0, i, :] * 255.0).permute(1, 2, 0).cpu().numpy().astype(np.uint8))
