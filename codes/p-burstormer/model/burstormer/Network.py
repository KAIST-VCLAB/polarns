...
from model.burstormer.utils.metrics import PSNR
...
class burstormer(nn.Module):
    def __init__(self, num_features=48, burst_size=8, reduction=8, bias=False):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(16, num_features, kernel_size=3, padding=1, bias=bias))
        ...
        self.out_conv = nn.Sequential(nn.Conv2d(num_features, 12, kernel_size=3, padding=1, bias=bias)) 
