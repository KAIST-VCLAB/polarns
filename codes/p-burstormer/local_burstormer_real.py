class Config:
    def __init__(self):
        ...
        self.path_model_selected = f'{self.path_model}/pburstormer_model_real.pth'
        self.path_image_original = "../../rsp_dataset/train_val/gt/val"
        self.path_image_gt = "../../PolarBurstSR/test"
        self.path_image_output = "../../PolarBurstSR/pburstormer_real"
        ...
        self.path_base_model = '../../checkpoints/pburstormer_model_syn.pth'
